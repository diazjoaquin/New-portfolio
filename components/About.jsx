                ...
                <section className="lg:w-9/12 h-full flex items-center justify-center font-serif">
                    <article className="w-8/12 md:w-9/12 h-full md:h-[75%] flex place-items-center md:px-6 md:gap-6 lg:gap-10 z-10">
                        <div className="lg:w-full h-[70%] md:h-5/6 md:pt-12 lg:pt-0 flex flex-col justify-center gap-6 md:gap-12 px-4 z-0">
                            ...
                            <a className="flex items-center justify-center" href="Díaz Joaquín - Fs Web Developer (Mar '24).pdf" download="Díaz Joaquín - Developer.pdf"><button className="text-white text-sm md:text-lg lg:text-xl bg-zinc-800 font-bold py-2 w-full lg:w-[50%] flex flex-row items-center justify-center gap-4 rounded-lg border-2 animate-fade-down animate-once animate-duration-[700ms] animate-delay-300 animate-ease-in hover:bg-zinc-700 font-sans">Download Resume <BsFileEarmarkArrowDown className="text-xl md:text-2xl text-teal-400"/></button></a>
                        </div>
                    </article>
                </section>
            </main> 
