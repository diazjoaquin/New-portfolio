                ...
                {currentTestimonials.map((testimonial) => {
                    return (
                        <div key={testimonial.id} className="lg:w-8/12 h-2/6 flex flex-col gap-2 animate-fade-down animate-duration-700 animate-ease-in animate-fill-both">
                            ...
                            <h3 className="text-teal-300 mx-2 text-center text-l font-bold font-sans">{testimonial.name}</h3>
                            <div className="border-2 px-2 mx-2 py-2 rounded-xl border-zinc-500 bg-zinc-800">
