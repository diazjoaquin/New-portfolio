...
export default function Technologies () {
    return (
        <section className="w-screen h-screen flex items-center justify-center">
                <main className="w-[70%] border-4 rounded-xl border-zinc-800 h-[80%] flex flex-col px-24 py-6 justify-around text-white font-sans font-bold animate-fade-up animate-ease-out animate-fill-both border-zinc-800 backdrop-blur-sm backdrop-saturate-50 backdrop-brightness-125">
