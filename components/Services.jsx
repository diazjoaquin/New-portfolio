...
export default function Services () {
    ...
    return (
        <main className="border-4 border-zinc-700 rounded-lg grid grid-rows-2 h-[80%] bg-zinc-800 justify-center w-9/12 px-4 font-sans animate-fade-up animate-delay-500 animate-ease-in">
