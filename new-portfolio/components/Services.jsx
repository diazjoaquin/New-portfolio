...
export default function Services () {
    ...
    return (
        <main className="border-4 border-zinc-800 rounded-lg grid grid-rows-2 h-[80%] justify-center w-9/12 px-4">
            <section className="flex">
                <div className="text-white w-full">
                    <h1 className="text-4xl uppercase px-4 py-4">Services</h1>
                    <section className="grid grid-cols-2 grid-rows-2 gap-y-48 h-full">
                        <div className="flex flex-col px-6 gap-2 py-2">
                            <h2 className="font-bold text-2xl flex items-center gap-2"><span className="border-2 border-emerald-600 rounded-full p-2 bg-emerald-600 hover:bg-emerald-500 hover:border-white hover:cursor-pointer"><BiLaptop/></span>Front-End Development</h2>
                            <p>
                        ...
                        <div className="flex flex-col px-6 gap-2 py-2">
                            <h2 className="font-bold text-2xl flex items-center gap-2"><span className="border-2 border-emerald-600 rounded-full p-2 bg-emerald-600 hover:bg-emerald-500 hover:border-white hover:cursor-pointer"><BiServer/></span>Back-End Development</h2>
                            <p>
                        ...
                        <div className="flex flex-col px-6 gap-2 py-2">
                            ...
                            <h2 className="font-bold text-2xl flex items-center gap-2"><span className="border-2 border-emerald-600 rounded-full p-2 bg-emerald-600 hover:bg-emerald-500 hover:border-white hover:cursor-pointer"><BsDatabaseFillCheck/></span>Database Management</h2>
                            <p>
