...
export default function Sidebar () {
    return (
        <div className="mx-5 space-y-2 text-gray-300 text-3xl fixed h-screen flex flex-col z-10 justify-center animate-fade animate-once animate-delay-[800ms] animate-ease-in">
