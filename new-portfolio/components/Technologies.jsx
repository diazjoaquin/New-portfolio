                    ...
                    <div className="w-2/6">
                        ...
                        <div className="flex gap-2">
                            {technologies.frontend.map((tool) => {
                                return (
                                    <span className="hover:cursor-pointer hover:scale-125 flex items-center border-2 py-2 px-2 min-w-[100px] rounded-xl bg-teal-400"><img className="object-contain object-center w-[100px] h-[60px]" src={tool.img} alt={tool.alt}/></span>
                                )
                            })}
                        </div>
                    </div>
