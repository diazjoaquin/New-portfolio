        ...
        <section className="relative bg-zinc-900 h-full">
            ...
            <main className="h-full relative">
                <section id="1" className="h-full flex items-center justify-center">
                    ...
                    <div className="lg:h-3/5 sm:h-4/5 sm:pt-12 lg:pt-0 flex flex-col gap-12 w-9/12 absolute z-0">
                        ...
                        <button className="text-white text-xl bg-zinc-800 font-bold py-2 lg:w-[25%] flex flex-row items-center justify-center gap-2 rounded-2xl border-2 animate-fade-down animate-once animate-duration-[1000ms] animate-delay-300 animate-ease-in hover:bg-zinc-700">Download Resume <BsFileEarmarkArrowDown className="text-2xl"/></button>
                    </div>
                    <button onClick={() => handleChangePage()} className="hidden lg:flex fixed bottom-20 right-20 text-white text-8xl font-bold animate-fade-left animate-duration-[800ms] animate-ease-in"><span>1</span></button>
                </section>
                <section id="2" className="hidden h-full flex items-center justify-center">
                    <Testimonials/>
                    <button onClick={() => handleChangePage()} className="hidden lg:flex fixed bottom-20 left-20 text-white text-8xl font-bold animate-fade-right animate-duration-[800ms] animate-ease-in"><span>2</span></button>
                </section>
            </main> 
        </section>
    );
