...
const Contact = () => {
    ...
    return (
        <section className="h-full bg-zinc-900">
            {/* <div className="absolute bottom-0 w-full h-[42%] bg-emerald-600 origin-bottom z-10 rounded-tr-[56%] rounded-tl-[65%]"></div> */}
            <Nav/>
            <Sidebar/>
            <main className="flex h-full justify-center items-center">
                <div className="z-10 bg-zinc-900 h-[70%] w-[60%] gap-10 flex flex-col justify-center items-center absolute rounded-xl lg:p-12 animate-fade-down animate-once animate-duration-[800ms] animate-delay-500 animate-ease-in border-4 border-zinc-800">
                    ...
                    <div className="lg:flex justify-center w-[80%]">
                        ...
                        <div className="w-[80%]">
                            <form className="flex flex-col items-center justify-center gap-5 w-[100%] mb-12 font-sans">
                                ...
                                <button className="w-full lg:w-[40%] text-white text-lg bg-emerald-600 hover:bg-emerald-500 px-6 py-2 rounded-md font-bold border-2 border-white" type='submit'>Submit</button>
                            </form>
                        </div>
                    </div>
                </div>
