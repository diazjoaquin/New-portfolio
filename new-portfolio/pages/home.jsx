...
export default function Home () {
    ...
    return (
        <section className="w-full h-full max-h-full flex bg-zinc-900">
            <div className="absolute bottom-0 w-full sm:h-[57%] lg:h-[42%] bg-emerald-600 origin-bottom z-10 rounded-tr-[56%] rounded-tl-[65%]"></div>
            <Nav/>
            <Sidebar/>
