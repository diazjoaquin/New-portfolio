    ...
    return (
        <section className="w-screen h-screen flex bg-zinc-900 overflow-hidden">
            ...
            <section className="w-screen flex items-center justify-center font-serif">
                <div className="lg:h-4/5 lg:flex flex-row  gap-12 w-9/12 items-center px-12 absolute">
                    ...
                    <article className="w-full h-full flex flex-col justify-center text-white uppercase tracking-[.05em] z-20 pt-4">
                        <p className="font-black font-sans pb-2 px-4 text-5xl md:text-6xl lg:text-7xl"><span className="italic text-4xl md:text-5xl text-teal-300">Full Stack </span> Web Developer</p>
                        <h3 className="flex items-center text-xl font-sans px-4 italic font-medium animate-fade-up animate-once lowercase">A curious mind Whit great passion.</h3>
                    </article>
                </div>
            </section>
        </section>
